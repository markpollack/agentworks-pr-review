	...
	class ComplexConflicts {
		...
		void shouldFailWhenComplexConflictsDetected() {
			ConflictReport complex = new ConflictReport(
					List.of(new com.tuvium.prreview.model.ConflictFile("App.java",
							com.tuvium.prreview.model.Classification.COMPLEX, "overlapping edits")),
		...
		void shouldPassWhenOnlySimpleConflicts() {
			ConflictReport simpleOnly = new ConflictReport(
					List.of(new com.tuvium.prreview.model.ConflictFile("pom.xml",
							com.tuvium.prreview.model.Classification.SIMPLE, "version bump")),
